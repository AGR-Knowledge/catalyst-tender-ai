 ...
 */
export {
  dg1RecordFor, dg1Queue, slaTextOf, roundOfDg1, reopensOf, DG1_SLA_HOURS,
  type Dg1State, type Dg1QueueItem, type Dg1HoldValue, type Dg1ReopenValue, type Dg1ReopenEntry, type AnyDg1,
} from './record';
